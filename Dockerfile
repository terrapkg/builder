...
RUN dnf5 in -y --setopt=install_weak_deps=False --repofrompath 'terra,https://repos.fyralabs.com/terra$releasever' --setopt='terra.gpgkey=https://repos.fyralabs.com/terra$releasever/key.asc' terra-{release{,-extras},mock-configs} subatomic-cli anda mock rpm-build mock-scm rpmlint git-{core,lfs} wget less podman fuse-overlayfs sudo gh dnf5-plugins createrepo_c
